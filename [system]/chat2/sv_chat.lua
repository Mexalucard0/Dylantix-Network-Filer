...
AddEventHandler('_chat:messageEntered', function(author, color, message)
    ...
    if not WasEventCanceled() then
        ...
        if vRP.hasPermission({user_id,"god.chattitle"}) then
            TriggerClientEvent('chatMessage', -1, "^5*G* ^0| ^5" ..author.." ^0(^5"..user_id.."^0): " ..  message)
        elseif vRP.hasPermission({user_id,"nighthawk.chattitle"}) then
            TriggerClientEvent('chatMessage', -1, "^1EJER ^0| ^1" ..author.." ^0(^1"..user_id.."^0): " ..  message)
        elseif vRP.hasPermission({user_id,"superadmin.chattitle"}) then
            TriggerClientEvent('chatMessage', -1, "^1LEDELSE ^0| ^1" ..author.." ^0(^1"..user_id.."^0): " ..  message)
        elseif vRP.hasPermission({user_id,"mod.chattitle"}) then    
            TriggerClientEvent('chatMessage', -1, "^3HJÆLPER ^0| ^3" ..author.." ^0(^3"..user_id.."^0): " ..  message)
        end
    end
