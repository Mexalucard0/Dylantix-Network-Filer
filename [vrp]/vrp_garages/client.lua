...
local garages = {
  ...
  {name="Garage", colour=3, id=357, marker=27, x=-159.29997253418, y=-1307.5187988281, z=31.253309249878, h=0.0, hidden=true},
  {name="Garage", colour=3, id=357, marker=27, x=480.1059, y=4820.0004, z=-58.9928, h=0.0, hidden=true},
  {name="Garage", colour=3, id=357, marker=27, x=-72.8969, y=356.7574, z=111.5000, h=0.0, hidden=true}, --gs
  {name="Garage", colour=3, id=357, marker=27, x=-824.05346679688, y=181.44486999512, z=71.681938171387, h=0.0, hidden=true}, --gs 
  {name="Garage", colour=3, id=357, marker=27, x=-348.19976806641, y=6217.3676757813, z=31.489673614502  , h=0.0, hidden=true}, --gs
  {name="Garage", colour=3, id=357, marker=27, x=1424.505859375, y=3618.9753417969, z=34.920970916748  , h=0.0, hidden=true}, --gs
}
vehicles = {}
...
Citizen.CreateThread(function()
  while true do
    ...
    for _, garage in pairs(garages) do
      DrawMarker(27, garage.x, garage.y, garage.z, 0, 0, 0, 0, 0, 0, 3.001, 3.0001, 0.5001, 0, 155, 255, 200, 0, 0, 0, 9000)
      	...
      	if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 then
      		if health >= 106 then	
          --  DrawText3D(lang_string.menu8,0,1,0.5,0.8,0.6,255,255,255,255)
            DrawText3D(garage.x, garage.y, garage.z + 1, lang_string.menu8, 0.1)
