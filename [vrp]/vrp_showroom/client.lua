	...
	menu = {
		...
		["BMW"] = {
			...
			buttons = {
				...
				{name = "BMW S1000RR", costs = 2500000, description = {}, model = "bmws"},
			}
		},
		["Honda"] = {
			title = "Honda",
		...
		["Lamborghini"] = {
			...
			buttons = {
				...
				{name = "Lamborghini Aventador 2", costs = 7500000, description = {}, model = "sv"},
			}
		},
		["Mercedes Benz"] = {
			title = "Mercedes Benz",
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					if vehshop.opened == false and IsPedInAnyVehicle(vehSR_LocalPed(), true) == false and GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(vehSR_LocalPed())) < 3 then
						...
						DrawText3D(-33.803,-1102.322,26.422, "Tryk [~g~E~s~] for at købe en ~b~bil")
						currentlocation = b
						inrange = true
					end
				end
...
function vehSR_ButtonSelected(button)
	...
	elseif this == "Aston Martin" or this == "Audi" or this == "BMW" or this == "Honda" or this == "Lamborghini" or this == "Mercedes Benz" or this == "Nissan" or this == "Porsche" or this == "Volkswagen" or this == "Andre" then
		TriggerServerEvent('veh_SR:CheckMoneyForVeh',button.model,button.name,button.costs,"car")
    elseif this == "Standard" then
...
function vehSR_Back()
	...
	if vehshop.currentmenu == "Bilforhandler" then
		vehSR_CloseCreator("","")
	elseif vehshop.currentmenu == "Aston Martin" or vehshop.currentmenu == "Audi" or vehshop.currentmenu == "BMW" or vehshop.currentmenu == "Honda" or vehshop.currentmenu == "Lamborghini" or vehshop.currentmenu == "Mercedes Benz" or vehshop.currentmenu == "Nissan" or vehshop.currentmenu == "Porsche" or vehshop.currentmenu  == "Volkswagen" or vehshop.currentmenu == "Andre" or vehshop.currentmenu ==  "Custom" or vehshop.currentmenu == "Standard" then
		if DoesEntityExist(fakecar.car) then
			DeleteEntity(fakecar.car)
		end
		fakecar = {model = '', car = nil}
