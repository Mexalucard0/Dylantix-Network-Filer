														...
														vRP.request(target,"<b>"..fornavnP.." "..efternavnP.."</b> ønsker at sælge sin <b>"..name.."</b> til en pris på <b style='color: #96D3FF'>"..amount.." DKK</b>", 10, function(target,ok)
															if ok then
																...
																-- if money >= amount then
																		...
																		PerformHttpRequest('https://canary.discordapp.com/api/webhooks/585844786569936924/aqEEyRuINYbNUmIlvtrOSsSiVwyi29UQB2W55KCcqDTM9HSwjN-ivZOjKJLXm_k43Myj', function(err, text, headers) end, 'POST', json.encode({username = "Salg af køretøj - Server " .. GetConvar("servernumber","0"), content = "**"..fornavnP.." "..efternavnP.." ("..p_id..")** solgte sit køretøj **"..name.."** til **"..fornavnT.." "..efternavnT.." ("..t_id..")** for **"..amount.." DKK**."}), { ['Content-Type'] = 'application/json' })
																else
