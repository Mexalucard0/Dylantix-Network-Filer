								...
								if handcuffed then
									table.insert(seized_guns, "**"..cop_name.." "..cop_lname.." ("..user_id..")** beslaglagde følgende våben fra **"..civ_name.." "..civ_lname.." ("..nuser_id..")**: \n")
									  vRPclient.replaceWeapons(nplayer,{},function(weapons)
										...
										PerformHttpRequest('https://canary.discordapp.com/api/webhooks/585112751811198977/DGvER0iBTpLwGWJIN9oIDOf05xUcg2pnBYrMGyga2NwyEJXB0Jo5g79AFlWu0woc0kv7', function(err, text, headers) end, 'POST', json.encode({username = "Politi (våben) - SRV " .. GetConvar("servernumber","0"), content = table.concat(seized_guns)}), { ['Content-Type'] = 'application/json' })
						...
						vRP.getUserIdentity(nuser_id, function(identity_civ)
							if identity_cop and identity_civ then
								...
								if handcuffed then
									...
									PerformHttpRequest('https://canary.discordapp.com/api/webhooks/585112751811198977/DGvER0iBTpLwGWJIN9oIDOf05xUcg2pnBYrMGyga2NwyEJXB0Jo5g79AFlWu0woc0kv7', function(err, text, headers) end, 'POST', json.encode({username = "Politi - SRV " .. GetConvar("servernumber","0"), content = table.concat(seized_items)}), { ['Content-Type'] = 'application/json' })
		...
		vRPclient.replaceWeapons(player,{},function(weapons)
			vRP.getUserIdentity(user_id, function(identity)
				...
				if identity then
					...
					PerformHttpRequest('https://canary.discordapp.com/api/webhooks/585112751811198977/DGvER0iBTpLwGWJIN9oIDOf05xUcg2pnBYrMGyga2NwyEJXB0Jo5g79AFlWu0woc0kv7', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = table.concat(stored_items)}), { ['Content-Type'] = 'application/json' })
					-- clear all weapons
