...
cfg.items = {
	...
	["skovsvampe"] = {"Skovsvampe", "Bruges til fremstilling af svampe.", nil, 0.20},
	["svampe"] = {"Svampe", "En kurv med svampe", nil, 0.10}, 
	...
	["pose"] = {"Pose", "Denne pose kan bruges til at sætte over hovedet på folk.", nil, 0.01}, -- nøgle til Trevors trailer 
	
	-- jobs
	["kuglepen"] = {"Kuglepen", "Bruges til at underskrive dokumenter til dine klienter.", nil,0.01}, -- advokat strips
	["strips"] = {"Strips", "Bruges til at binde folk.", nil,0.01}, -- strips
