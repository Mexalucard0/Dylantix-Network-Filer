  ...
  -- FISK
	...
	["Kokaplante farm"] = {
		...
		positions = {
			...
			{356.31561279297,6478.0458984375,29.606895446777}
		},
		duration = math.random(120,300) -- 5 days (time before switching position, min 5 mins.)
	},
	["Kokain fremstilling"] = {
	...
	["Svampe farm"] = {
		def = {
			...
			radius=12, height=5.5, -- area
			blip=false, -- Should transformer have blip
			blipid="svampefarm", -- Unique id for blip
			blipicon=501,
			blipcolor=1,
			marker=false,
			markerid=0,
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Samler Skovsvampe"] = { -- action name
					description="Samler Skovsvampe til at fremstille Svampe.", -- action description
					work=3,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={}, -- items taken per unit
		...
		positions = {
			{3286.0456542969,5185.1674804688,18.415353775024}
		},
		duration = 120-- 5 days (time before switching position, min 5 mins.)
	},
	["Svampe fremstilling"] = {
		def = {
			name="Svampe fremstilling", -- menu name
			permissions = {"drugseller.process"}, -- you can add permissions
			r=200,g=0,b=0, -- color
			max_units=200,
			units_per_minute=35,
			...
			radius=5.5, height=1.5, -- area
			blip=true, -- Should transformer have blip
			blipid="svampeprocess", -- Unique id for blip
			blipicon=497,
			blipcolor=1,
			marker=false,
			markerid=0,
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Fremstiller svampe"] = { -- action name
					description="Omdan skovsvampe til svampe.", -- action description
					work=3,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={ -- items taken per unit
		...
		positions = {
			{-98.666580200195,6204.91015625,31.025026321411}
		},
		duration = 65 -- 5 days (time before switching position, min 5 mins.)
	},
	["Svampe Salg"] = { -- Coke dealer
		def = {
			name="Svampe Salg", -- menu name
			permissions = {"drugseller.sell"}, -- you can add permissions
			r=200,g=0,b=0, -- color
			max_units=200,
			units_per_minute=35,
			...
			radius=5, height=2.5, -- area
			blip=false, -- Should transformer have blip
			blipid="Svampe Salg", -- Unique id for blip
			blipicon=280,
			blipcolor=1,
			marker=false,
			markerid=0,
			markerdata={0,0,0,0,0,0,0,0}, -- sx,sy,sz,r,g,b,a,vis_distance
			recipes = {
				["Sælger svampe"] = { -- action name
					description="Sælg dine svampe.", -- action description
					work=2,
					in_money=0, -- money taken per unit
					out_money=0, -- money earned per unit
					reagents={ -- items taken per unit
		...
		positions = {
			{1392.5751953125,3602.5422363281,38.941898345947}
		},
		duration = 120 -- 5 days (time before switching position, min 5 mins.)
	},
