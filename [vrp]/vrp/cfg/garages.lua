...
cfg.garage_types = {
	["Politi"] = {
		...
		["fbi"] = {"Mercedes Civil ",0, "fbi"},
		["fbi2"] = {"Audi Patrulje",0, "fbi2"},
		["sheriff"] = {"VW Passat Patrulje",0, "sheriff"},
		["sheriff2"] = {"VW Passat Civil",0, "sheriff2"},
		["police"] = {"VW Arteon Patrulje",0, "police"},
		["police2"] = {"VW Touran Patrulje",0, "police2"},
		["police3"] = {"Range Rover",0, "police3"},
		["police4"] = {"BMW Civil",0, "police4"},
		["policeb"] = {"BMW MC",0, "policeb"},
		["policeold2"] = {"Audi Civil",0, "policeold2"},
		["policeold5"] = {"VW T5 Indsatsleder",0, "policeold5"},
		["riot"] = {"AKS Vogn",0, "riot"}
	},
	["Ambulanceredder"] = {
	...
	["Hells Angels"] = {
		_config = {vtype="default",blipid=0,blipcolor=0,permissions={"ha.vehicle"}},
		["hexer"] = {"Hells Angels MC 1",50000, ""},
		["daemon"] = {"Hells Angels MC 2",30000, ""}
	},	
	["Advokat"] = {
...
cfg.garages = {
	...
	{"Mekaniker",-182.18922424316,-1319.3249511719,31.29598236084,false,false},
	...
	{"Hells Angels",954.66729736328,-126.74269866943,74.363800048828,true,false}
}
