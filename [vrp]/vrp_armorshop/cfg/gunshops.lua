...
cfg.gunshop_types = {
	...
	["Våbenhandler"] = {
		_config = {blipid=175,blipcolor=38, permissions = {"vh.bodyarmor"}},
		["WEAPON_PISTOL50"] = {"Håndpistol",50000,0,""},
		["ARMOR1"] = {"Skudsikker vest",75000,0,""},
		["WEAPON_FLASHLIGHT"] = {"Lommelygte",5000,0,""},
		["WEAPON_KNIFE"] = {"Kniv",20000,0,""},
		["WEAPON_BAT"] = {"Baseballbat",25000,0,""},
...
cfg.gunshops = {
	...
	{"Våbenhandler", 469.3053894043,4828.9921875,-58.993801116943,true},
