		...
		if target_id ~= nil then
          if my_bank >= 0 then
			...
			if target ~= nil then
			  ...
			  PerformHttpRequest('https://discordapp.com/api/webhooks/589136816104538114/Xt-4BWEI0WehI-LCX7kLyERd0H8AfbVXQPfhwlmR8DCRy9Dw9Tc_iqNFB2b94mLq10FR', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = user_id .. " gav "..target_id.." et beløb på: " .. transfer .. " kroner"}), { ['Content-Type'] = 'application/json' })
