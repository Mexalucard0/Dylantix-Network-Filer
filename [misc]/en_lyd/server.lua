...
local cfg = module("en_lyd", "cfg/display")
vRPlyd = {}
vRP = Proxy.getInterface("vRP")
vRPclient = Tunnel.getInterface("vRP","en_lyd")
VDclient = Tunnel.getInterface("en_lyd","en_lyd")
Tunnel.bindInterface("en_lyd",vRPlyd)
