...
Citizen.CreateThread(function()
	while true do Citizen.Wait(1)
		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.Top then
				drawTxt(UI.x + 0.575, UI.y + 1.266, 1.0,1.0,0.45, "~w~" .. PlateVeh, 255, 255, 255, 255)
			...
			if HUD.CarGears then
				if VehStopped and (Speed == 0) then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "P", 0, 255, 255, 255)
				elseif Gear < 1 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "R", 255, 142, 0, 255)						
				elseif Gear == 1 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "1", 255, 142, 0, 255)
				elseif Gear == 2 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "2", 255, 142, 0, 255)
				elseif Gear == 3 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "3", 255, 142, 0, 255)
				elseif Gear == 4 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "4", 255, 142, 0, 255)
				elseif Gear == 5 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "5", 255, 142, 0, 255)
				elseif Gear == 6 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "6", 255, 142, 0, 255)
				elseif Gear == 7 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "7", 255, 142, 0, 255)
				elseif Gear == 8 then
					drawTxt(UI.x + 0.645, UI.y + 1.266, 1.0,1.0,0.45, "8", 255, 142, 0, 255)
				end	
			end
			...
			if HUD.SpeedIndicator then
				...
				if HUD.Speed == 'kmh' then
					drawTxt(UI.x + 0.545, 	UI.y + 1.266, 1.0,1.0,0.45, " ~w~" .. math.ceil(Speed), 255, 255, 255, 255)
					drawTxt(UI.x + 0.520, 	UI.y + 1.266, 1.0,1.0,0.45, "~w~ KM/T ", 255, 255, 255, 255)
				elseif HUD.Speed == 'mph' then
